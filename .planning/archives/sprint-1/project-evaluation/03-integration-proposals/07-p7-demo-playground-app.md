...
format; a tiny artboard canvas using `@komeilm76/km-artboard` math; a tile/projection inspector using
`@komeilm76/km-map`. It is **not** part of the published packages (the no-DOM rule stands) — it lives
